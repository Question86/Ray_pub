...
def push_to_github():
    ...
    try:
        ...
        subprocess.run(["git", "remote", "add", "origin", "https://Question86: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@github.com/https://github.com/Question86/Ray_pub.git"], check=True)
